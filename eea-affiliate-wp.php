<?php
/*
  Plugin Name: Event Espresso - AffiliateWP integration (EE4.x+)
...
define( 'EE_AFFILIATE_WP_CORE_VERSION_REQUIRED', '4.8.0.rc.0000' );
define( 'EE_AFFILIATE_WP_VERSION', '1.0.0.rc.001' );
